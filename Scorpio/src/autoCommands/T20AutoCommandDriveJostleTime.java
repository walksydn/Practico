...
public class T20AutoCommandDriveJostleTime extends Scorpio implements T20Command {
	private boolean isFinished, isStarted;
	private double speed, time, heading;
	private Timer driveTimer = new Timer();

	public T20AutoCommandDriveJostleTime(double speed, double time) {
	...
	public T20Command copy() {
		return new T20AutoCommandDriveJostleTime(this.speed, this.time);
	}
